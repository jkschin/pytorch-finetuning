...
class CustomDataset(Dataset):
    def __init__(self, root_dir, transform=None):
        ...
        self.total = len(os.listdir(os.path.join(root_dir, "inputs_thick_224")))
    ...
    def __getitem__(self, idx):
        inp_name = os.path.join(self.root_dir, "inputs_thick_224", "input_%05d.png" %idx)
        ...
        out_name = os.path.join(self.root_dir, "outputs_thick_224", "output_%05d.png" %idx)
